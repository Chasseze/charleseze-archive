...
function Placeholder({
  ...
  if (src) {
    return /*#__PURE__*/React.createElement("div", {
      className: "ph ph-filled " + (className || "")
...
function SectionHead({
  ...
  return /*#__PURE__*/React.createElement("header", {
    ...
    className: "ghost-index",
    "aria-hidden": "true"
  }, index), /*#__PURE__*/React.createElement("div", {
    className: "kicker"
  }, index, " — ", label), /*#__PURE__*/React.createElement("h1", {
    className: "h-display"
  }, title));
}
function StageFoot({
  ...
  }, /*#__PURE__*/React.createElement("span", null, meta), /*#__PURE__*/React.createElement("span", null, "© ", new Date().getFullYear(), " ", D.identity.name));
}
function AboutSection({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "lede about-lede"
  }, D.identity.tagline), /*#__PURE__*/React.createElement("div", {
    className: "body-copy"
  }, a.paragraphs.map((p, i) => /*#__PURE__*/React.createElement("p", {
    key: i
  }, p))), onNavigate && /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "inline-cta",
    onClick: () => onNavigate("projects")
  }, /*#__PURE__*/React.createElement("span", null, "View selected work"), /*#__PURE__*/React.createElement("span", {
    className: "inline-cta-arrow",
    "aria-hidden": "true"
  }, "→"))), /*#__PURE__*/React.createElement("aside", {
    className: "about-aside"
  }, /*#__PURE__*/React.createElement(Placeholder, {
    label: "Portrait of Charles Eze",
    className: "portrait",
    src: "assets/images/portrait.jpg"
  }), /*#__PURE__*/React.createElement("p", {
    className: "photo-caption"
  }, "Charles Eze · ChassEZE Group"), /*#__PURE__*/React.createElement("div", {
    className: "fact-list"
  }, a.facts.map((f, i) => /*#__PURE__*/React.createElement("div", {
    className: "fact",
    key: i
  }, /*#__PURE__*/React.createElement("span", {
    className: "k"
    ...
    className: "v"
  }, f.v)))))), /*#__PURE__*/React.createElement(StageFoot, {
    meta: "INDEX / 00"
  }));
}
function ExperienceSection() {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    index: "01",
    label: "Experience",
    title: "A decade of shipping digital work."
  }), /*#__PURE__*/React.createElement("div", {
    className: "timeline"
  }, D.experience.map((e, i) => /*#__PURE__*/React.createElement("article", {
    className: "tl-row",
    key: i
  }, /*#__PURE__*/React.createElement("div", {
    className: "period"
  }, e.period), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    className: "tl-role"
  }, e.role), /*#__PURE__*/React.createElement("p", {
    className: "tl-org"
  }, e.org), /*#__PURE__*/React.createElement("p", {
    className: "tl-detail"
  }, e.detail))))), /*#__PURE__*/React.createElement(StageFoot, {
    meta: "INDEX / 01"
  }));
}
...
function ProjectCard({
  ...
  return /*#__PURE__*/React.createElement("a", {
    ...
    className: "p-year"
  }, p.year)), featured && p.outcome && /*#__PURE__*/React.createElement("p", {
    className: "p-outcome"
  }, p.outcome), /*#__PURE__*/React.createElement("p", {
    className: "p-blurb"
  }, p.blurb), external && /*#__PURE__*/React.createElement("span", {
    className: "p-link"
  }, "Visit project ", /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true"
  }, "↗"))));
}
function ProjectsSection() {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    index: "03",
    label: "Projects",
    title: "Selected work from the archive."
  }), /*#__PURE__*/React.createElement("div", {
    className: "projects"
...
function NotesSection() {
  ...
  if (note) {
    ...
    }, "←"), /*#__PURE__*/React.createElement("span", null, "All notes")), /*#__PURE__*/React.createElement("article", {
      className: "note-detail"
    }, /*#__PURE__*/React.createElement("div", {
      className: "note-head"
    }, /*#__PURE__*/React.createElement("span", {
      className: "note-topic"
    }, note.topic), /*#__PURE__*/React.createElement("span", {
      className: "note-meta"
    }, note.date, " · ", note.read)), /*#__PURE__*/React.createElement("h1", {
      className: "note-detail-title"
    }, note.title), /*#__PURE__*/React.createElement("div", {
      className: "note-body"
    }, /*#__PURE__*/React.createElement("p", null, note.summary), note.body.map((p, i) => /*#__PURE__*/React.createElement("p", {
      key: i
    }, p))), /*#__PURE__*/React.createElement("div", {
      className: "note-takeaways"
    }, /*#__PURE__*/React.createElement("span", {
      className: "note-takeaways-label"
    }, "Key takeaways"), /*#__PURE__*/React.createElement("ul", null, note.takeaways.map((t, i) => /*#__PURE__*/React.createElement("li", {
      key: i
    }, t)))), /*#__PURE__*/React.createElement("div", {
      className: "note-tags"
    }, note.tags.map(tag => /*#__PURE__*/React.createElement("span", {
      className: "note-tag",
      key: tag
    }, tag)))), /*#__PURE__*/React.createElement(StageFoot, {
      meta: "INDEX / 04 — " + note.topic.toUpperCase()
    }));
  }
  return /*#__PURE__*/React.createElement("section", {
    className: "section"
    ...
    className: "note-topic"
  }, n.topic), /*#__PURE__*/React.createElement("h3", {
    className: "note-item-title"
  }, n.title), /*#__PURE__*/React.createElement("p", {
    className: "note-item-blurb"
  }, n.summary)), /*#__PURE__*/React.createElement("div", {
    className: "note-item-meta"
  }, /*#__PURE__*/React.createElement("span", null, n.date), /*#__PURE__*/React.createElement("span", null, n.read))))), /*#__PURE__*/React.createElement(StageFoot, {
    meta: "INDEX / 04"
  }));
}
function ContactForm() {
  ...
  return /*#__PURE__*/React.createElement("form", {
    ...
    required: true,
    rows: "5",
    placeholder: "Tell me about the work, timeline, and goals."
  })), /*#__PURE__*/React.createElement("div", {
  ...
  }, status === "loading" ? "Sending…" : "Send message", /*#__PURE__*/React.createElement("span", {
    className: "contact-submit-arrow",
    "aria-hidden": "true"
  }, "→")), message && /*#__PURE__*/React.createElement("p", {
    className: "contact-form-status is-" + status,
    role: "status"
  }, message)));
}
function ContactSection() {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "lede contact-lede"
  }, c.blurb), /*#__PURE__*/React.createElement("a", {
    className: "contact-email",
    href: "mailto:" + c.email
  }, c.email), /*#__PURE__*/React.createElement(ContactForm, null)), /*#__PURE__*/React.createElement("aside", {
  ...
  }, c.links.map((l, i) => /*#__PURE__*/React.createElement("a", {
    className: "clink",
    href: l.href,
    key: i,
    ...
    className: "v"
  }, l.v)))))), /*#__PURE__*/React.createElement(StageFoot, {
    meta: "INDEX / 05"
  }));
}
const SECTION_MAP = {
...
function ThemeToggle() {
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    d: "M13.8 9.9A6 6 0 0 1 6.1 2.2a.4.4 0 0 0-.5-.5 6.6 6.6 0 1 0 8.7 8.7.4.4 0 0 0-.5-.5Z"
  })));
}
function Clock() {
...
function TopBar({
  ...
  }, D.identity.name), /*#__PURE__*/React.createElement("span", {
    className: "sep mono"
  }, "/"), /*#__PURE__*/React.createElement("span", {
    className: "sub"
  }, D.identity.role)), /*#__PURE__*/React.createElement("div", {
    className: "status"
  }, /*#__PURE__*/React.createElement(Clock, null), extra, /*#__PURE__*/React.createElement("span", {
    className: "dot"
  }), /*#__PURE__*/React.createElement("span", null, D.identity.status.toUpperCase()), /*#__PURE__*/React.createElement(ThemeToggle, null)));
}
function SectionNav({
  active,
  setActive
  ...
  return /*#__PURE__*/React.createElement("nav", {
    ...
    className: "sn-arrow left"
  }, "◀"), /*#__PURE__*/React.createElement("span", null, prev.index), /*#__PURE__*/React.createElement("span", {
    className: "sn-label"
    ...
    className: "sn-label"
  }, next.label), /*#__PURE__*/React.createElement("span", null, next.index), /*#__PURE__*/React.createElement("span", {
    className: "sn-arrow right"
  }, "▶")));
}
function ArchiveShell({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "skip-link",
    href: "#main-content"
  }, "Skip to content"), /*#__PURE__*/React.createElement(TopBar, {
    onHome: onHome,
    extra: /*#__PURE__*/React.createElement("span", null, "ARCHIVE / ", active.toUpperCase())
  }), /*#__PURE__*/React.createElement("div", {
    ...
    className: "v"
  }, D.identity.location)), /*#__PURE__*/React.createElement("div", {
    className: "row"
  }, /*#__PURE__*/React.createElement("span", {
    className: "k"
  }, "Since"), /*#__PURE__*/React.createElement("span", {
    className: "v"
  }, D.identity.started)), /*#__PURE__*/React.createElement("div", {
    className: "row"
  }, /*#__PURE__*/React.createElement("span", {
    className: "k"
  }, "Contact"), /*#__PURE__*/React.createElement("span", {
    className: "v"
  }, D.contact.email)))), /*#__PURE__*/React.createElement("main", {
    ...
    className: "stage"
  }, children, /*#__PURE__*/React.createElement(SectionNav, {
    active: active,
    setActive: setActive
  })))));
}
function EditorialShell({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onHome: onHome,
    extra: /*#__PURE__*/React.createElement("span", null, "EDITORIAL")
  }), /*#__PURE__*/React.createElement("div", {
    ...
    className: "ni"
  }, n.index), n.label))), /*#__PURE__*/React.createElement("main", {
    className: "edi-stage",
    id: "main-content",
    tabIndex: "-1"
  }, children, /*#__PURE__*/React.createElement(SectionNav, {
...
function Cover({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "cover-top"
  }, /*#__PURE__*/React.createElement("span", null, "The Archive"), /*#__PURE__*/React.createElement("span", {
    className: "cover-top-right"
  }, /*#__PURE__*/React.createElement("span", null, "Vol. 01 — ", year), /*#__PURE__*/React.createElement(ThemeToggle, null))), /*#__PURE__*/React.createElement("div", {
    ...
    className: "kicker cover-kicker"
  }, "The Archive & Digital Portfolio"), /*#__PURE__*/React.createElement("h1", {
    className: "cover-name"
  }, /*#__PURE__*/React.createElement("span", {
    className: "cover-name-1"
  }, first), " ", /*#__PURE__*/React.createElement("span", {
    className: "cover-name-2"
  }, rest.join(" "))), /*#__PURE__*/React.createElement("p", {
    ...
    className: "v"
  }, D.identity.started))), /*#__PURE__*/React.createElement("button", {
...
function App() {
  ...
  const sectionProps = active === "about" ? {
    onNavigate: selectSection
  } : {};
  const tweaks = /*#__PURE__*/React.createElement(TweaksPanel, {
    title: "Tweaks"
  ...
  }), t.direction === "archive" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(TweakSection, {
    label: "Sidebar"
  }), /*#__PURE__*/React.createElement(TweakRadio, {
    label: "Style",
    value: t.sidebar,
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Shell, {
    ...
    onHome: goHome
  }, /*#__PURE__*/React.createElement(SectionComp, sectionProps)), tweaks);
}
